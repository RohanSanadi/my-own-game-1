...
function draw() {
  ...
  player.scale=0.4
  if(keyDown("space")&&ballGroup.length===0){
    bullet--
blast()
  }
  ...
  stroke("black")
  strokeWeight(10)
      text("YOU ARE A BAD SHOOTER",displayWidth/2,displayHeight/2)
      
    }else if(score>5&&score<8){
      textSize(30) 
      stroke("black")
      strokeWeight(10)
          text("YOU ARE  A GOOD SHOOTER",displayWidth/2,displayHeight/2)
     }else if(score>=8){
      textSize(30) 
      stroke("black")
      strokeWeight(10)
          text("YOU ARE AN EXCELLENT SHOOTER",displayWidth/2,displayHeight/2)
    }
  }
  textSize(21) 
  stroke("black")
